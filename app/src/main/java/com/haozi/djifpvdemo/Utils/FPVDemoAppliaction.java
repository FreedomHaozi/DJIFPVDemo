package com.haozi.djifpvdemo.Utils;
...
/**
 * Created by 彪悍的小Y on 2017/3/3.
 */

public class FPVDemoAppliaction extends Application {
        ...
        public void onGetRegisteredResult(DJIError error) {
            ...
            if (error == DJISDKError.REGISTRATION_SUCCESS) {
                ...
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(getApplicationContext(), "大疆 SDK Register Success", Toast.LENGTH_LONG).show();
                        Log.i("tag","大疆 SDK Register Success");
                    }
                });
